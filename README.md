...
Features of each cameras are saved in seperated mat files named "results_cam#.mat". For the evaluation using [1], copy these feature files to "./feature" directory and set "feature_info.name" in demo.m file (line 6) as "results".
